...
export default function Services() {
  ...
  {isSm&&(  <>
    ...
    <Grid container sx={{ padding: '0 4%', paddingTop: '128px', }}>
      <Grid item md={7}>
        <Box>
          <img src={routes_autoriutes_transports} style={{ width: '100%', height: '508px', borderRadius: '8px' }} />
...
<Grid container sx={{ padding: '0 4%', paddingTop: '128px', }}>
  <Grid item md={7}>
    <Box>
      <img src={routes_autoriutes_transports} style={{ width: '100%', height: '300px', borderRadius: '8px' }} />
