...
export default function DetailRealisation() {
  useEffect(() => {
    ...
    const images = [
        ...
        {
            original: immeuble_appartement_R3_Kinshasa_1,
            thumbnail: immeuble_appartement_R3_Kinshasa_1,
        },
     
        {
            original: immeuble_appartement_R3_Kinshasa_2,
            thumbnail: immeuble_appartement_R3_Kinshasa_2,
        },
        {
            original: immeuble_appartement_R3_Kinshasa_3,
            thumbnail: immeuble_appartement_R3_Kinshasa_3,
        },
        {
            original: immeuble_appartement_R3_Kinshasa_4,
            thumbnail: immeuble_appartement_R3_Kinshasa_4,
        },
        {
            original: immeuble_appartement_R3_Kinshasa_5,
            thumbnail: immeuble_appartement_R3_Kinshasa_5,
        },
        {
            original: immeuble_appartement_R3_Kinshasa_6,
            thumbnail: immeuble_appartement_R3_Kinshasa_6,
        },
    ...
    return (
        <>
             <Typography variant='h4'  color='#424242' sx={{fontFamily: 'Montserrat, sans-serif', paddingTop:'48px', margin: '0 5%'}}>Construction d’un immeuble appartement R+3<br></br> à Kinshasa</Typography>
