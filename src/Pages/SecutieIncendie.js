  ...
  {isSm&&(  <>
    ...
    <div style={{ height: '470px', position: 'relative' }}  >
      ...
      <Box style={{ position: 'absolute', top: 0, display: 'block', height: '470px', width: '100%' }}>
        ...
        {isSm&&(    <Typography variant="h2" style={{fontSize:'2.488 rem',color:'white',fontFamily: 'Montserrat, sans-serif', fontWeight: 'bold' }} >Sécurité contre l’incendie dans les constructions</Typography>

)}
    {isXs&&(  <Typography variant="h3" style={{fontSize:'2.488 rem',color:'white',fontFamily: 'Montserrat, sans-serif', fontWeight: 'bold' }} >Sécurité contre l’incendie dans les constructions</Typography>
      ...
      <Grid item md={5} >
        <Grid container>
          ...
          <Grid item md={11}  >
            ...
            <Typography variant='body2' color='#9e9e9e' sx={{ fontFamily: 'Montserrat, sans-serif', paddingBlockStart: '48px' }} >Mesures de prévention et de sécurité pour protéger les bâtiments contre les incendies</Typography>
...
<Grid container sx={{ padding: '0 4%', paddingTop: '128px', }}>
  ...
  <Grid item md={5} >
    <Grid container>
      ...
      <Typography variant='body2' color='#9e9e9e' sx={{ fontFamily: 'Montserrat, sans-serif' ,paddingLeft:'10px'}}>Mesures de prévention et de sécurité pour protéger les bâtiments contre les incendies
</Typography>
    </Box>
